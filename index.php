      ...
      <center>
        ...
        if(!isset($_GET["q"])) {
                  ...
                  if (isset($ad)) {
                    ...
                    $_SESSION['webserver'] = shell_exec('curl -LI -m '.$time.' ' . $_SESSION['ip'] . ' | grep Server: | head -1'); // "-m 5" Sets the timeout for web server software request. Default value = 5. Time in seconds.
